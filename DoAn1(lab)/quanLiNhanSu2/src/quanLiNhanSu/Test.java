	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			System.out.println("\t\t| 1.Them moi nhan su                                       |\r\n"
					...
					+ "\t\t| 12.Liet ke theo ngay sinh(Nguoi cao tuoi hien thi truoc) |\r\n"
			...
			if (luachon == 1) {
				while (true) {
					...
					if (chon == 1) {
						...
						//Giá trị được người dùng nhập vào sẽ được lưu vào biến namSinhInput
						String namSinhInput = sc.nextLine();
						/*tạo một đối tượng DateTimeFormatter với định dạng "dd/MM/yyyy", 
						 * tức là ngày/tháng/năm. Để người dùng nhập chính xác ngày tháng
						 * năm sinh của nhân sự nếu nhập khác định dạnh chương trình sẽ 
						 * xảy ra lỗi*/
						DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy");
						/*parse() của lớp LocalDate để chuyển đổi chuỗi ngày sinh (namSinhInput) 
						 *thành đối tượng LocalDate, sử dụng đối tượng formatter để định dạng và phân tích chuỗi.*/						
						...
						System.out.println("So Gio Lam: ");
						Float soGioLamViec = sc.nextFloat();
						ChuyenGiaNuocNgoai cgnn = new ChuyenGiaNuocNgoai(maNhanVien, hoVaTen, namSinh, gioiTinh, soDienThoai, daThoiViec, soGioLamViec, chuyenNghanh, thamNien, quocTich, ngayHetHanVisa);
						...
						System.out.println("So Gio Lam: ");
						Float soGioLamViec = sc.nextFloat();
						NhanVienPartTime nvbtg = new NhanVienPartTime(maNhanVien, hoVaTen, namSinh, gioiTinh, soDienThoai, daThoiViec, soGioLamViec, nangSuat);
						...
						System.out.println("So Gio Lam: ");
						Float soGioLamViec = sc.nextFloat();
						CanBoQuanLy cbql = new CanBoQuanLy(maNhanVien, hoVaTen, namSinh, soDienThoai, gioiTinh, daThoiViec, soGioLamViec, namKinhNghiem);
